package ru.openpulse.mod.features.modules;
...
import static ru.openpulse.mod.core.Managers.NOTIFICATION;
...
public abstract class Module {
    ...
    protected void sendPacketSilent(Packet<?> packet) {
        if (mc.getNetworkHandler() == null) return;
        PulseMod.core.silentPackets.add(packet);
        mc.getNetworkHandler().sendPacket(packet);
    }
    ...
    public void disable() {
        try {
            PulseMod.EVENT_BUS.unsubscribe(this);
