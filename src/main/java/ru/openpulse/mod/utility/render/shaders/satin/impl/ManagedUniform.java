...
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.Uniform1i;
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.Uniform2f;
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.Uniform2i;
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.Uniform3f;
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.Uniform3i;
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.Uniform4f;
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.Uniform4i;
import ru.openpulse.mod.utility.render.shaders.satin.api.managed.uniform.UniformMat4;
