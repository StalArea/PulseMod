...
public final class PulseUtility {
    ...
    public static void syncVersion() {
        try {
            if (!new BufferedReader(new InputStreamReader(new URL("https://raw.githubusercontent.com/StalArea/PMUtil/main/syncVersion.txt").openStream())).readLine().equals(PulseMod.VERSION))
    ...
    public static void syncContributors() {
        try {
            URL list = new URL("https://raw.githubusercontent.com/StalArea/PMUtil/main/pmTeam.txt");
    ...
    public static void parseCommits() {
        try {
            URL url = new URL("https://api.github.com/repos/StalArea/PulseMod/commits?per_page=5");
