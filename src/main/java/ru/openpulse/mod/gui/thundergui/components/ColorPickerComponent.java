...
public class ColorPickerComponent extends SettingElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (copy_focused) PulseMod.copy_color = getColorSetting().getColorObject();
        if (paste_focused)
            setColor(PulseMod.copy_color == null ? getColorSetting().getColorObject() : PulseMod.copy_color);
    }
