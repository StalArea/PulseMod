package ru.openpulse.mod.gui.windows.impl;
...
import ru.openpulse.mod.gui.clickui.impl.SliderElement;
import ru.openpulse.mod.gui.font.FontRenderers;
import ru.openpulse.mod.gui.windows.WindowBase;
...
public class FriendsWindow extends WindowBase {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
        ...
        for (FriendPlate friendPlate : friendPlates) {
            ...
            boolean online = mc.player != null && mc.player.networkHandler.getPlayerList().stream().map(p -> p.getProfile().getName()).toList().contains(friendPlate.name());
