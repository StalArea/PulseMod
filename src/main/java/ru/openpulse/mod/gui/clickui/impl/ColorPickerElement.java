...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        boolean dark = Render2DEngine.isDark(PulseMod.copy_color);
        ...
        Render2DEngine.drawRect(matrixStack, x + 63f, y + 54f, 24, 7, PulseMod.copy_color);
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        else if (copyHovered) PulseMod.copy_color = getColorSetting().getColorObject();

        else if (pasteHovered) getColorSetting().setColor(PulseMod.copy_color.getRGB());
